...
const MISSING: readonly string[] = [
  ...
  "tune.deline",
  "tune.engraver",
  "tune.findSelectableElement",
  "tune.formatting",
  "tune.getBarLength",
  "tune.getBeatLength",
  "tune.getBeatsPerMeasure",
  "tune.getBpm",
  "tune.getElementFromChar",
  "tune.getKeySignature",
  "tune.getMeter",
  "tune.getMeterFraction",
  "tune.getPickupLength",
