...
const PASSING: readonly string[] = [
  ...
  "abcjs-visual-parsing-12-song",
  // 2026-09-22: six tunes the abcjs 6.7.1 re-harvest added, byte-exact on arrival —
  // `layout-10-text-a` after the unbarred-line `%%text` fix in `beginMusicLine`.
  "abcjs-synth-timing-13-a-b-c-d-e-f-g",
  "abcjs-synth-timing-14-a-b-c-d-e-f-g",
  "abcjs-visual-layout-10-text-a",
  "abcjs-visual-parsing-10-main",
  "abcjs-visual-parsing-11-c2-d2-e2-f2-k-f-g2-a2-b2-c2",
  "abcjs-visual-parsing-13-class-alice-a-class-bob-t-dfa",
