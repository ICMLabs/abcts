...
const EXPECTED: Record<string, { heads: number; dy: number; dx: number; oy: number; ox: number }> =
  {
    ...
    'multi-voice-lyrics-two-voices': { heads: 16, dy: 26.7, dx: 52.4, oy: -26.0, ox: -9.2 },
    ...
    'ragtime-nightingale': { heads: 2009, dy: 85.1, dx: 99.5, oy: 11.9, ox: -19.8 },
    ...
    'two-voice-invention': { heads: 74, dy: 11.9, dx: 23.1, oy: 16.0, ox: -15.1 },
