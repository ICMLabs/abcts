...
const EXPECTED: Record<string, { heads: number; dy: number; dx: number; oy: number; ox: number }> =
  {
    'ave-verum-corpus': { heads: 55, dy: 26.8, dx: 29.3, oy: -1.7, ox: -17.2 },
    'brother-john-inline-voices': { heads: 64, dy: 0.0, dx: 16.7, oy: -0.2, ox: -13.7 },
    'center-text': { heads: 8, dy: 0.0, dx: 3.9, oy: 10.1, ox: -9.4 },
    'chord-grid': { heads: 16, dy: 0.0, dx: 7.0, oy: -20.4, ox: -16.7 },
    'frere-jacques': { heads: 45, dy: 47.3, dx: 41.8, oy: -19.7, ox: -18.8 },
    'full-song-template': { heads: 20, dy: 22.1, dx: 19.8, oy: -33.4, ox: -20.4 },
    'happy-birthday': { heads: 25, dy: 10.0, dx: 36.6, oy: -0.7, ox: -27.3 },
    'little swallow': { heads: 89, dy: 24.6, dx: 47.5, oy: -11.1, ox: -27.1 },
    'multi-voice-lyrics-two-voices': { heads: 16, dy: 67.7, dx: 52.4, oy: -87.4, ox: -9.2 },
    'multi-voice-rest-collision': { heads: 7, dy: 0.0, dx: 4.5, oy: -42.1, ox: -8.5 },
    'multi-voice-rest-placement': { heads: 14, dy: 0.0, dx: 19.8, oy: -7.1, ox: -13.1 },
    'multi-voice-triplet-brackets': { heads: 45, dy: 4.8, dx: 110.2, oy: -36.1, ox: -9.6 },
    'program-127-test': { heads: 20, dy: 13.7, dx: 14.3, oy: -3.2, ox: -18.3 },
    'ragtime-mini': { heads: 30, dy: 0.0, dx: 19.9, oy: -21.1, ox: -17.7 },
    'ragtime-nightingale': { heads: 2009, dy: 151.7, dx: 99.5, oy: -26.6, ox: -19.8 },
    ...
    'stacked-annotations': { heads: 4, dy: 0.0, dx: 4.5, oy: -21.5, ox: -5.0 },
    twinkle: { heads: 14, dy: 0.0, dx: 5.7, oy: -0.2, ox: -12.5 },
    'two-voice-invention': { heads: 74, dy: 11.9, dx: 23.1, oy: 15.1, ox: -15.1 },
    'voice-middle-after-clef': { heads: 10, dy: 12.7, dx: 79.0, oy: -7.8, ox: -21.4 },
    ...
    'zocharti-loch': { heads: 64, dy: 3.0, dx: 48.9, oy: 9.3, ox: -9.4 },
  }
