...
have committed visual baselines. 215 tests.
...
diff to follow. What remains is known from the code: multi-voice and system breaking (only voice 0 of
tune 0, on one endless staff — the largest gap), proportional spacing, repeat/final
barline shapes. See the checkpoint.
