...
have committed visual baselines. 206 tests.
...
diff to follow. What remains is known from the code: flags and beams (an unbeamed eighth
is indistinguishable from a quarter), multi-voice and system breaking, proportional
spacing, repeat/final barline shapes. See the checkpoint.
