...
**STATE MOVED AGAIN ON 2026-08-03c. `Docs/CHECKPOINT-2026-08-03c.md` is the current state
and `Docs/HANDOFF-2026-08-03c.md` says where to start — it corrects two statements in the
